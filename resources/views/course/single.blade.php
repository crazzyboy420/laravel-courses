                ...
                <ol role="list" class="flex items-center space-x-0.5">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="-m-1">
                                <a href="{{route('course',$course->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{$course->title}} </a>
                            </div>
                        </div>
                    </li>
                </ol>
            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <div class="rounded-sm mt-8 shadow-sm bg-white">
                        <img class="w-full" src="{{$course->image_url}}" alt="Testing Laravel">
                    </div>
                ...
                <div class="w-1/3 pl-10 pt-0">
                    ...
                    <div class="overflow-hidden bg-white border border-gray-200 rounded-sm shadow-sm">
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            @foreach($course->authors as $index => $author)
                             @if($index <2)
                                    <div class="space-y-4 pb-2">
                                        <div class="aspect-w-3 aspect-h-2">
                                            <img class="object-cover w-48 m-auto shadow" src="{{Gravatar::get($author->email)}}" alt="Freek Van der Herten Profile Picture">
                                        </div>
                                        ...
                                        <ul role="list" class="flex space-x-5 justify-center">
                                            <li>
                                                <a href="{{$author->twitter_link}}" class="text-gray-400 hover:text-gray-500" target="_blank">
                                            ...
                                            <li>
                                                <a href="{{$author->github_link}}" class="text-gray-400 hover:text-gray-500" target="_blank">
                                            ...
                                            <li>
                                                <a href="{{$author->website_link}}" class="text-gray-400 hover:text-gray-500" target="_blank">
